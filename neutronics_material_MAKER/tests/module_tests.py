...
class Tester(unittest.TestCase):
    ...
    def test_isotope_description(self):
        new_isotope = nmm.Isotope('Li',7)    
    ...
    def test_element_enriched_isotope_natural(self):
        new_element = nmm.Element('Fe')
    ...
    def test_compound_enriched_isotopes_natural(self):
        new_compound = nmm.Compound('Li4SiO4')
    ...
    def test_material_density_g_per_cm3(self):
        new_material = nmm.Material('SS-316LN-IG')
        assert new_material.density_g_per_cm3 > 0
    ...
    def test_material_find_material_mass_or_atom_faction_mixture_length(self):
        new_material = nmm.Material('SS-316LN-IG')
