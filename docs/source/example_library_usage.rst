...
Assuming you have a JSON file saved as mat_lib.json containing materials defined in the same format as the `exisiting <https://github.com/ukaea/neutronics_material_maker/blob/openmc_version/neutronics_material_maker/data/>`_ materials
