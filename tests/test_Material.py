...
class test_object_properties(unittest.TestCase):
    ...
    def test_temperature_to_neutronics_code_serpent(self):
        ...
        test_mat = nmm.Material.from_library(name="FLiBe", temperature=180, pressure=2)
    ...
    def test_fispact_material(self):
        ...
        assert dict_of_fispact_mats["Li6"] == pytest.approx(3.537400925715e21)
        assert dict_of_fispact_mats["Li7"] == pytest.approx(4.307481314353e22)
        assert dict_of_fispact_mats["Si28"] == pytest.approx(1.074757396925e22)
        assert dict_of_fispact_mats["Si29"] == pytest.approx(5.457311411014e20)
        assert dict_of_fispact_mats["Si30"] == pytest.approx(3.597484069651e20)
        assert dict_of_fispact_mats["O16"] == pytest.approx(4.650130496709e22)
        assert dict_of_fispact_mats["O17"] == pytest.approx(1.766602913225e19)
    ...
    def test_fispact_material_with_volume(self):
        ...
        assert dict_of_fispact_mats["Li6"] == pytest.approx(7.074801851431e21)
        assert dict_of_fispact_mats["Li7"] == pytest.approx(8.614962628707e22)
        assert dict_of_fispact_mats["Si28"] == pytest.approx(2.149514793849e22)
        assert dict_of_fispact_mats["Si29"] == pytest.approx(1.091462282203e21)
        assert dict_of_fispact_mats["Si30"] == pytest.approx(7.194968139301e20)
        assert dict_of_fispact_mats["O16"] == pytest.approx(9.300260993419e22)
        assert dict_of_fispact_mats["O17"] == pytest.approx(3.533205826449e19)
        assert dict_of_fispact_mats["O18"] == pytest.approx(1.864861460483e20)
    ...
    def test_mcnp_material_suffix(self):
        ...
        test_material3 = nmm.Material.from_library(name="Nb3Sn", material_id=27)
    ...
    def test_serpent_material_suffix(self):
        test_material1 = nmm.Material.from_library(name="Nb3Sn", zaid_suffix=".21c")
        serpent_material1 = test_material1.serpent_material

        test_material2 = nmm.Material.from_library(name="Nb3Sn", zaid_suffix=".30c")
    ...
    def test_incorrect_settings(self):
        ...
        def test_incorrect_name_type():
            ...
            test_material = nmm.Material.from_library(
                "H2O", temperature=283, pressure=-1e6
            )
        ...
        def test_incorrect_density_unit_type():
            ...
            nmm.Material.from_library(
                "eurofer", density=1.0, density_unit="grams per cm3"
            )
        ...
        def test_incorrect_percent_type_type():
            ...
            nmm.Material.from_library(
                "eurofer", density=1.0, percent_type="weight percent"
            )
        ...
        def test_incorrect_enrichment_type_type():
            ...
            nmm.Material.from_library(
                "eurofer", density=1.0, enrichment_type="weight percent"
            )
        ...
        def test_incorrect_atoms_per_unit_cell():
            ...
            nmm.Material.from_library("eurofer", atoms_per_unit_cell=-1.0)
        ...
        def test_incorrect_volume_of_unit_cell_cm3():
            ...
            nmm.Material.from_library("eurofer", volume_of_unit_cell_cm3=-1.0)
        ...
        def test_incorrect_temperature():
            ...
            nmm.Material.from_library("eurofer", temperature=-1.0)
        ...
        def test_incorrect_zaid_suffix_type():
            ...
            nmm.Material.from_library("eurofer", zaid_suffix=0.80)
        ...
        def test_too_small_packing_fraction():
            ...
            nmm.Material.from_library("eurofer", packing_fraction=-0.1)
        ...
        def test_chemical_equation_wrong_type():
            ...
            nmm.Material.from_library("eurofer", chemical_equation=-0.1)
        ...
        def test_enrichment_too_high():
            ...
            nmm.Material.from_library(
                "Li4SiO4", enrichment=101, enrichment_target="Li6"
            )
        ...
        def test_enrichment_too_low():
            ...
            nmm.Material.from_library("Li4SiO4", enrichment=-1, enrichment_target="Li6")
        ...
        def test_pressure_too_low():
            ...
            nmm.Material.from_library("Li4SiO4", pressure=-1)
        ...
        def test_comment_wrong_type():
            ...
            nmm.Material.from_library("Li4SiO4", comment=-1)
    ...
    def test_json_dump_contains_correct_keys_2(self):
        test_material = nmm.Material.from_library(name="Li4SiO4", enrichment=90)
        test_material_in_json_form = test_material.to_json()
    ...
    def test_json_dump_contains_correct_values(self):
        test_material = nmm.Material.from_library("H2O", temperature=373, pressure=1e6)
        test_material_in_json_form = test_material.to_json()
    ...
    def test_temperature_from_C_in_materials(self):
        ...
        test_material = nmm.Material.from_library(
            "H2O", temperature=383, pressure=15.5e6
        )
    ...
    def test_temperature_from_K_in_materials(self):
        ...
        test_material = nmm.Material.from_library(
            "H2O", temperature=300, pressure=15.5e6
        )
